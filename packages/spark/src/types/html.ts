import { type SparkNode } from './jsx.js'
...
export namespace HTML {
  ...
  export interface GlobalAttributes<T extends EventTarget>
    extends EventAttributes<T>, Aria.Attributes {
  ...
  export interface AnchorAttributes<T extends EventTarget> extends GlobalAttributes<T> {
  ...
  interface ImgAttributes<T extends EventTarget>
    extends GlobalAttributes<T>, LoaderElementAttributes<T> {
    alt?: string
  ...
  export interface InputAttributes<T extends EventTarget>
    extends GlobalAttributes<T>, InputElementAttributes<T> {
    accept?: string
    alt?: string
    autoComplete?: string
